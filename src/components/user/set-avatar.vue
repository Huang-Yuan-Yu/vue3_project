                ...
                <div>
                    ...
                    <transition-group name="userAvatarDiv">
                        ...
                        >
                            ...
                            <div v-if="userAvatarData" id="userAvatarDiv">
                                <img id="userAvatar" :src="userAvatarData" alt="用户头像" />
                            </div>
                    ...
                    <el-row v-if="isFirstCroppingCompleted === true || isCrop === true" id="buttonElRow">
                        <el-col :span="12">
                            ...
                            <el-button v-if="isCrop === true" size="large" type="primary" @click="cancelCropping">
                                图片归位
                            </el-button>
                            <el-button v-else size="large" type="primary" @click="reCrop">重新裁剪</el-button>
                        </el-col>
                        <el-col :span="12">
                            <el-button v-if="isCrop === true" size="large" type="primary" @click="cutFinished">
                                裁剪完毕
                            </el-button>
                            <el-button v-else size="large" type="primary" @click="sendImage">确认头像</el-button>
                        </el-col>
                    </el-row>
                </div>
            </div>
